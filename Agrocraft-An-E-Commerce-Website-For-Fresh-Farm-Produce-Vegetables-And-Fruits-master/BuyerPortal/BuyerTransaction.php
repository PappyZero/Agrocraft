    ...
    <div class="headerdown">
        ...
        <div id="majic" class="headerdown ">
            ...
            <select id="states" onchange="state()" tabindex="1">
                ...
                <option value="28">ABIA</option>
                <option value="29">ADAMAWA</option>
                <option value="30">AKWA IBOM</option>
                <option value="31">ANAMBRA</option>
                <option value="32">BAUCHI</option>
                <option value="33">BAYELSA</option>
                <option value="34">BENUE</option>
                <option value="35">BORNO</option>
                <option value="36">CROSS RIVER</option>
                <option value="37">DELTA</option>
                <option value="38">EBONYI</option>
                <option value="39">EDO</option>
                <option value="40">EKITI</option>
                <option value="41">ENUGU</option>
                <option value="42">GOMBE</option>
                <option value="43">IMO</option>
                <option value="44">JIGAWA</option>
                <option value="45">KADUNA</option>
                <option value="46">KANO</option>
                <option value="47">KATSINA</option>
                <option value="48">KEBBI</option>
                <option value="49">KOGI</option>
                <option value="50">KWARA</option>
                <option value="51">LAGOS</option>
                <option value="52">NASSARAWA</option>
                <option value="53">NIGER</option>
                <option value="54">OGUN</option>
                <option value="55">ONDO</option>
                <option value="56">OSUN</option>
                <option value="57">OYO</option>
                <option value="58">PLATEAU</option>
                <option value="59">RIVERS</option>
                <option value="60">SOKOTO</option>
                <option value="61">TARABA</option>
                <option value="62">YOBE</option>
                <option value="63">ZAMFARA</option>
            </select>
